...
<table class="table table-bordered py-3" id="result" width="100%">
    <thead>
        <tr>
            ...
            <th scope="col" rowspan="2">Ratio</th>
            <th scope="col" rowspan="2">Absent Ratio</th>
            <th scope="col" rowspan="2">SL</th>
            <th scope="col" rowspan="2">VL</th>
            <th scope="col" rowspan="2">UA</th>
            <th scope="col" rowspan="2">Late</th>
